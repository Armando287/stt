...
echo #EXT-X-MEDIA:TYPE=AUDIO,GROUP-ID="audio",NAME="Principal",URI=%filename%_audio_0.m3u8,DEFAULT=YES,AUTOSELECT=YES>> master.m3u8
echo #EXT-X-MEDIA:TYPE=AUDIO,GROUP-ID="audio",NAME="Secundario",LANGUAGE="SC",URI=%filename%_audio_1.m3u8,DEFAULT=NO,AUTOSELECT=NO>> master.m3u8
